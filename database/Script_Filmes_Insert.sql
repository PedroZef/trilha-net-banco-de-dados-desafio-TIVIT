-- os comandos de inserção ficticios 

USE Filmes;
GO

-- 1. Inserindo Atores
INSERT INTO Atores (PrimeiroNome, UltimoNome, Genero) VALUES ('Michael', 'J. Fox', 'M');
INSERT INTO Atores (PrimeiroNome, UltimoNome, Genero) VALUES ('Christopher', 'Lloyd', 'M');
INSERT INTO Atores (PrimeiroNome, UltimoNome, Genero) VALUES ('Lea', 'Thompson', 'F');
...
INSERT INTO Atores (PrimeiroNome, UltimoNome, Genero) VALUES ('Jodie', 'Foster', 'F');

-- 2. Inserindo Filmes
-- Id 1: De Volta para o Futuro (Para o exercício 3)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('De Volta para o Futuro', 1985, 116);
-- Id 2: Titanic (Para o exercício 4 - Ano 1997)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('Titanic', 1997, 194);
-- Id 3: Matrix (Para teste geral)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('Matrix', 1999, 136);
-- Id 4: A Origem (Para o exercício 5 - Ano > 2000 e exercício 6 - Duração entre 100 e 150)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('A Origem', 2010, 148);
-- Id 5: Seven: Os Sete Crimes Capitais (Para o exercício 11 - Mistério)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('Seven: Os Sete Crimes Capitais', 1995, 127);
-- Id 6: O Silêncio dos Inocentes (Outro Mistério)
INSERT INTO Filmes (Nome, Ano, Duracao) VALUES ('O Silêncio dos Inocentes', 1991, 118);

-- 3. Inserindo Gêneros
INSERT INTO Generos (Genero) VALUES ('Ficção Científica'); -- Id 1
INSERT INTO Generos (Genero) VALUES ('Romance');           -- Id 2
INSERT INTO Generos (Genero) VALUES ('Drama');             -- Id 3
INSERT INTO Generos (Genero) VALUES ('Mistério');          -- Id 4
INSERT INTO Generos (Genero) VALUES ('Ação');              -- Id 5

-- 4. Inserindo FilmesGenero (Ligação)
-- De Volta para o Futuro (1) -> Ficção (1)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (1, 1);
-- Titanic (2) -> Romance (2)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (2, 2);
-- Titanic (2) -> Drama (3)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (2, 3);
-- Matrix (3) -> Ficção (1)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (3, 1);
-- A Origem (4) -> Ficção (1)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (4, 1);
-- A Origem (4) -> Mistério (4)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (4, 4);
-- Seven (5) -> Mistério (4)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (5, 4);
-- O Silêncio dos Inocentes (6) -> Mistério (4)
INSERT INTO FilmesGenero (IdFilme, IdGenero) VALUES (6, 4);

-- 5. Inserindo ElencoFilme (Ligação Atores e Filmes)
-- Michael J. Fox (1) em De Volta para o Futuro (1)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (1, 1, 'Marty McFly');
-- Christopher Lloyd (2) em De Volta para o Futuro (1)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (2, 1, 'Dr. Emmett Brown');
-- Leonardo DiCaprio (4) em Titanic (2)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (4, 2, 'Jack Dawson');
-- Kate Winslet (5) em Titanic (2)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (5, 2, 'Rose DeWitt Bukater');
-- Leonardo DiCaprio (4) em A Origem (4)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (4, 4, 'Cobb');
-- Brad Pitt (7) em Seven (5)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (7, 5, 'Detective David Mills');
-- Jodie Foster (8) em O Silêncio dos Inocentes (6)
INSERT INTO ElencoFilme (IdAtor, IdFilme, Papel) VALUES (8, 6, 'Clarice Starling');


-- Agora os comandos inicial do projeto
